//! Launching and watching the disposable agent process.
//!
...
mod tests {
    ...
    #[test]
    fn stopping_an_already_reaped_agent_signals_nothing() {
...
pub trait Link {
    ...
    /// race on the ordinary path and reports an agent that simply exited as a channel fault.
    ///
